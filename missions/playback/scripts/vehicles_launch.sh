...
rm -f AUV_3.bhv
#echo "      * removed the existing AUV_3 BHV file"

nsplug vehicle_bhv.meta AUV_3.bhv -f ${FLAGS} VEHICLE_NAME=AUV_3 MISSION_ROOT=${MISSION_ROOT}
#echo "      * built new BHV file from plugs"
...
rm -f AUV_3.moos
#echo "      * removed the existing AUV_3 MOOS file"

nsplug vehicle_moos.meta AUV_3.moos -f ${FLAGS} VEHICLE_NAME=AUV_3 MISSION_ROOT=${MISSION_ROOT} RUNTYPE=${RUNTYPE}
#echo "      * built new shoreside MOOS file from plugs"
...
sleep 1
pAntler AUV_3.moos >& /dev/null &
echo "      * launched the new AUV_3 MOOS file"
sleep 1
